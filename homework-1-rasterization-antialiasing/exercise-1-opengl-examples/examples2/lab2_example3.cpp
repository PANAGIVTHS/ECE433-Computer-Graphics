...
//--------------------------------------------------------------------------------------------------------------------------------
// H entolh glutPostRedisplay():
// requests that the callback registered with glutDisplayFunc() be called as soon as possible.
// This is preferred over calling your rendering routine directly, since the user may have interacted
// with your application and user input events need to be processed.
...
int main(int argc, char** argv) {
    ...
    glutCreateWindow("glutMouseFunc2");              // create window
