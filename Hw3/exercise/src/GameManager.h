...
private:
    ...
    // --- NEW: Global pointers for Ray Tracing ---
    inline static Cube *testCube = nullptr; 
    inline static Object *sun = nullptr;
    // --------------------------------------------
...
public:
    static constexpr GLfloat speed = 4.137f;
    static constexpr GLfloat sensitivity = 0.03f;
    static constexpr GLfloat gravity = 9.81f; 
    static constexpr GLfloat jumpSpeed = 4.0f; 
    ...
    // --- NEW: Accessors for Ray Tracing ---
    static Cube* getTestCube();
    static void setSun(Object* s);
    static Object* getSun();
    // --------------------------------------
