...
void init(void) 
{
	...
	//GLfloat light0_ambient[] = {1.0, 0.0, 0.0, 1.0}; // RED Ambient Because of light0
	...
	// A directional light (try it as positional)
	...
	GLfloat lmodel_ambient[] = {0.3, 0.3, 0.3, 1.0}; // General, not because of a specific light source
